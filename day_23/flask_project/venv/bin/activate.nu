...
export-env {
    ...
    let virtual_env = r#'/Users/jordanstevenparratorres/Library/CloudStorage/OneDrive-aughters/Documents/Proyectos/Python/30DaysOfPython/day_23/flask_project/venv'#
    let bin = r#'bin'#
